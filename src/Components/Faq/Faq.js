...
const Faq = () => {
    ...
    return (
        <div className='mt-28 mb-28' id='advice'>
            <div className='flex justify-center items-center text-center'>
                ...
                <div className='flex justify-center mt-10'>
                    ...
                    <div className='w-80 rounded-2xl'>
                        ...
                        <div className='pt-10 pl-3 pb-3 pr-3 border shadow-2xl rounded-3xl text-center hover:bg-red-200'>
                    ...
                    <div className='w-80 rounded-2xl'>
                        ...
                        <div className='pt-10 pl-3 pb-3 pr-3 text-center border shadow-2xl rounded-3xl hover:bg-green-200'>
                    ...
                    <div className='w-80 rounded-2xl'>
                        ...
                        <div className=' pt-10 pl-3 pb-3 pr-3 text-center border shadow-2xl rounded-3xl hover:bg-sky-200'>
